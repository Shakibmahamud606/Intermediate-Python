...
Most people live in middle income countries where difference in lifespan is huge between countries;
...
3)China has both a lower GDP per capita and lower life expectancy compared to India.

Answers:  1)The countries in blue, corresponding to Africa, have both low life expectancy and a low GDP per capita.
